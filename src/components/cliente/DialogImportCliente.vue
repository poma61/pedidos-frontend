    ...
    <v-card v-if="shows_import_data.show_errors">
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
                ...
                <v-btn color="cyan-darken-1" variant="outlined" class="ma-1" @click="reImport">
    ...
    <v-card v-if="shows_import_data.show_import">
        ...
        <v-card-text class="text-center">
            ...
            <v-file-input label="Seleccionar archivo excel" v-model="selected_file" prepend-icon="mdi-file-excel"
                accept="application/vnd.openxmlformats-officedocument.spreadsheetml.sheet" color="cyan-darken-1" show-size>
            </v-file-input>
        ...
        <v-card-actions>
            <v-spacer></v-spacer>
                ...
                <v-btn color="cyan-darken-1" variant="outlined" class="ma-1" @click="confirmImportData">
