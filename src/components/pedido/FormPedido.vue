<template>
    <v-card class="mb-3">
        ...
        <v-card-text>
            <v-row>
                <v-col cols="12" sm="4">
                    <v-text-field color="deep-purple-darken-1" label="Nombres" v-model="item_cliente.nombres"
                        :error-messages="showFieldsErrors('nombres')" variant="underlined" />
                </v-col>
                <v-col cols="12" sm="4">
                    <v-text-field color="deep-purple-darken-1" label="Apellido Paterno" v-model="item_cliente.apellido_paterno"
                        :error-messages="showFieldsErrors('apellido_paterno')" variant="underlined" />
                </v-col>

                <v-col cols="12" sm="4">
                    <v-text-field color="deep-purple-darken-1" label="Apellido materno" v-model="item_cliente.apellido_materno"
                        :error-messages="showFieldsErrors('apellido_materno')" variant="underlined" />
                </v-col>

                <v-col cols="12" sm="6">
                    <v-text-field color="deep-purple-darken-1" label="Correo electronico" v-model="item_cliente.email"
                        :error-messages="showFieldsErrors('email')" variant="underlined" />
                </v-col>

                <v-col cols="12" sm="6">
                    <v-text-field color="deep-purple-darken-1" label="N° de contacto (celular)" v-model="item_cliente.n_contacto"
        ...
        <v-card-actions>
            ...
            <v-btn color="deep-purple-darken-1" variant="outlined" @click="saveChild">
